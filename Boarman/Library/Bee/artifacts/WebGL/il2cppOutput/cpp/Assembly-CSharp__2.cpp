...
struct DemoCarController_tC9E7D29C6EB423DF23A234482F66985ECA011ADB;
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DemoCarController_Start_mDA7BB8C6D1B41C0F170750A887F052BD4815BF06 (DemoCarController_tC9E7D29C6EB423DF23A234482F66985ECA011ADB* __this, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL_001c:
	{
		List_1_t991BBC5A1D51F59A450367DF944DAA207F22D06D* L_2 = __this->___children;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DemoCarController_Update_m8B46753A07D8BAA20C0A18472A0C537907AD91B6 (DemoCarController_tC9E7D29C6EB423DF23A234482F66985ECA011ADB* __this, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
	...
	float G_B4_1 = 0.0f;
	float G_B9_0 = 0.0f;
	DemoCarController_tC9E7D29C6EB423DF23A234482F66985ECA011ADB* G_B9_1 = NULL;
	float G_B8_0 = 0.0f;
	DemoCarController_tC9E7D29C6EB423DF23A234482F66985ECA011ADB* G_B8_1 = NULL;
	float G_B10_0 = 0.0f;
	float G_B10_1 = 0.0f;
	DemoCarController_tC9E7D29C6EB423DF23A234482F66985ECA011ADB* G_B10_2 = NULL;
	{
		float L_0;
		...
		V_1 = L_1;
		float L_2 = V_0;
		float L_3 = __this->___maxWheelRotation;
		__this->___totalRotation = ((float)il2cpp_codegen_multiply(L_2, L_3));
		V_2 = 0;
		goto IL_008e;
	}
...
IL_0028:
	{
		float L_4 = __this->___addedRotation;
		TransformU5BU5D_tBB9C5F5686CAE82E3D97D43DF0F3D68ABF75EC24* L_5 = __this->___wheels;
		int32_t L_6 = V_2;
		int32_t L_7 = L_6;
...
IL_004e:
	{
		float L_11 = __this->___totalRotation;
		G_B4_0 = L_11;
		G_B4_1 = G_B3_0;
	}
...
IL_0054:
	{
		...
		L_12 = Quaternion_Euler_m9262AB29E3E9CE94EF71051F38A28E82AEC73F90_inline(G_B4_1, G_B4_0, (0.0f), NULL);
		V_3 = L_12;
		TransformU5BU5D_tBB9C5F5686CAE82E3D97D43DF0F3D68ABF75EC24* L_13 = __this->___wheels;
		int32_t L_14 = V_2;
		int32_t L_15 = L_14;
		...
		L_24 = Quaternion_Lerp_m259606226726C2F46E079A5A688B9E24FF7E9A0D(L_21, L_22, ((float)il2cpp_codegen_multiply(L_23, (20.0f))), NULL);
		Transform_set_localRotation_mAB4A011D134BA58AB780BECC0025CA65F16185FA(L_16, L_24, NULL);
		int32_t L_25 = V_2;
...
IL_008e:
	...
	{
		float L_29 = __this->___currentAccelerationTime;
		float L_30 = V_1;
...
IL_00bd:
	{
		G_B10_2->___currentAccelerationTime = ((float)il2cpp_codegen_add(G_B10_1, G_B10_0));
		goto IL_00e0;
	}

IL_00c5:
	{
		float L_33 = __this->___currentAccelerationTime;
		float L_34;
		L_34 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		float L_35;
		L_35 = Mathf_MoveTowards_m69751B5EC50D8E7127D4BB2C8D908E38808AF45D_inline(L_33, (0.0f), L_34, NULL);
		__this->___currentAccelerationTime = L_35;
	}

IL_00e0:
	{
		float L_36 = __this->___currentAccelerationTime;
		float L_37 = __this->___accelerationTime;
		float L_38 = __this->___accelerationTime;
		float L_39;
		L_39 = Mathf_Clamp_mEB9AEA827D27D20FCC787F7375156AF46BB12BBF_inline(L_36, ((-L_37)), L_38, NULL);
		__this->___currentAccelerationTime = L_39;
		float L_40 = V_1;
	...
	{
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_41 = __this->___farCam;
...
IL_0119:
	{
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_43 = __this->___farCam;
...
IL_012a:
	{
		float L_45 = __this->___addedRotation;
		float L_46 = __this->___currentAccelerationTime;
		__this->___addedRotation = ((float)il2cpp_codegen_add(L_45, L_46));
		bool L_47;
		L_47 = Input_GetKey_mE5681EF775F3CEBA7EAD7C63984F7B34C8E8D434(((int32_t)50), NULL);
		if (!L_47)
		{
			goto IL_0170;
		}
	...
	{
		float L_48 = __this->___hueTime;
		float L_49;
		L_49 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		__this->___hueTime = ((float)il2cpp_codegen_add(L_48, L_49));
		float L_50 = __this->___hueTime;
	...
	{
		__this->___hueTime = (0.0f);
	}

IL_0170:
	{
		bool L_51;
		L_51 = Input_GetKey_mE5681EF775F3CEBA7EAD7C63984F7B34C8E8D434(((int32_t)49), NULL);
		if (!L_51)
		{
			goto IL_01a3;
		}
	...
	{
		float L_52 = __this->___brightness;
		float L_53;
		L_53 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		__this->___brightness = ((float)il2cpp_codegen_add(L_52, L_53));
		float L_54 = __this->___brightness;
	...
	{
		__this->___brightness = (0.0f);
	}

IL_01a3:
	{
		MeshRenderer_t4B7747212F0B88244BB7790C61AE124BFC15BAAE* L_55 = __this->___carBase;
		...
		String_t* L_57 = __this->___colorPropertyName;
		float L_58 = __this->___hueTime;
		float L_59 = __this->___brightness;
		Color_tD001788D726C3A7F1379BEED0260B9591F440C1F L_60;
		L_60 = Color_HSVToRGB_m1E66966AAB74D56DB4D339B65E60E2AF435C8105_inline(L_58, L_59, (1.0f), NULL);
		Material_SetColor_mFAB32FAA44461E46FD707B34184EC080CBB3539F(L_56, L_57, L_60, NULL);
		return;
	}
}
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DemoCarController_FixedUpdate_m7D08E3868605B068BA8EED24A75C8E8F790F4017 (DemoCarController_tC9E7D29C6EB423DF23A234482F66985ECA011ADB* __this, const RuntimeMethod* method) 
{
	{
		float L_0 = __this->___currentAccelerationTime;
		float L_1 = __this->___maxSpeed;
		float L_2;
		L_2 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		__this->___currentVelocity = ((float)il2cpp_codegen_multiply(((float)il2cpp_codegen_multiply(L_0, L_1)), L_2));
		...
		float L_9 = __this->___currentVelocity;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_10;
		...
		float L_12 = __this->___currentVelocity;
	...
	}
	{
		...
		float L_18 = __this->___totalRotation;
		float L_19 = __this->___currentAccelerationTime;
		float L_20;
		L_20 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		Quaternion_tDA59F214EF07D7700B26E40E562F267AF7306974 L_21;
		L_21 = Quaternion_Euler_m9262AB29E3E9CE94EF71051F38A28E82AEC73F90_inline((0.0f), ((float)il2cpp_codegen_multiply(((float)il2cpp_codegen_multiply(((float)il2cpp_codegen_multiply(L_18, (30.0f))), L_19)), L_20)), (0.0f), NULL);
		...
		Rigidbody_MoveRotation_m85825C7206E770E39DED9EE6D792702F577A891D(L_13, L_24, NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DemoCarController__ctor_m163632011D53FE82C5D595FDBDA6766203292B9B (DemoCarController_tC9E7D29C6EB423DF23A234482F66985ECA011ADB* __this, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
	...
	}
	{
		...
		__this->___maxWheelRotation = (40.0f);
		__this->___colorPropertyName = _stringLiteralDA39A3EE5E6B4B0D3255BFEF95601890AFD80709;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___colorPropertyName), (void*)_stringLiteralDA39A3EE5E6B4B0D3255BFEF95601890AFD80709);
		__this->___brightness = (1.0f);
